function PLUGIN:EnvKeys(ctx)
	...
	-- TRULY USE POETRY: Run a dummy command. If the .venv doesn't exist,
	...
	-- Query the exact path generated by Poetry's virtualenv manager
	...
	if venv_path and venv_path ~= "" then
		...
		-- Execute automated dependency sync if requested
		...
		-- Push directly into the execution path wrapper
		ctx.path:prepend(venv_bin)

		-- Double bind to force standard shells to register the change
		return {
